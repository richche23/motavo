          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0">
                ...
                <p className="text-sm mt-0.5 truncate" style={{ color: 'var(--text-3)' }}>{station.address}</p>
              </div>
          ...
          <>
            <div className="flex items-center gap-3 p-4 md:p-5"
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-tiny truncate" style={{ color: 'var(--text-3)' }}>{station.address}</div>
              </div>
